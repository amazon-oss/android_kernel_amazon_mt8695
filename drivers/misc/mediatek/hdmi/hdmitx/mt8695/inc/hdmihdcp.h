...
extern HDMI_AV_INFO_T *_prAvdAVInfo;
extern unsigned int _u4HDMI1CFG;
extern unsigned int _u4HDMI2CFG;
extern unsigned char hdcp2_version_flag;
extern unsigned char load_bin_flag;
...
extern void vHDMIClearINT(void);
extern void vShowHdcpStatus(void);
extern void hdcp_unmute_process(void);
extern void hdcp_unmute_logo(void);
extern int hdmi_audio_signal_state(unsigned int state);
extern unsigned int bHDMIHDCP2Err(void);
extern bool fgHDMIHdcp2Auth(void);
extern void hdmi_hdcp22_monitor_init(void);
extern void hdmi_hdcp22_monitor_start(void);
extern void hdmi_hdcp22_monitor_stop(void);
extern void hdmi_hdcp22_monitor(void);
